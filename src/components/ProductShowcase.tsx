  ...
  return (
    <section id="products" className="py-16 relative" style={{ backgroundColor: '#f5efea' }}>
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto bg-background rounded-xl shadow-lg overflow-hidden border-2 border-primary/10 transition-shadow hover:shadow-xl duration-300" style={{ backgroundColor: '#f5efea' }}>
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-6 md:p-10 flex flex-col items-center justify-center" style={{ backgroundColor: '#f5efea' }}>
              ...
              <Button
                size="lg"
                className="w-full max-w-xs rounded-xl text-lg font-semibold transition-all hover:shadow-lg duration-200"
